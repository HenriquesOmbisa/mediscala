...
const TABS = [
  { name: "shifts", label: "Escala", Icon: Calendar },
...
function ManagerTabBar({ state, navigation }: any) {
...
export default function ManagerLayout(): ReactElement {
  return (
    <Tabs
    ...
    >
      <Tabs.Screen name="shifts" options={{ title: "Escala da equipa" }} />
