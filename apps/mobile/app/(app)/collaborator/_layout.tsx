...
const TABS = [
  { name: "shifts", label: "Turnos", Icon: Calendar },
...
function CollaboratorTabBar({ state, navigation }: any) {
...
export default function CollaboratorLayout(): ReactElement {
  return (
    <Tabs
      tabBar={(props) => <CollaboratorTabBar {...props} />}
      screenOptions={{
        headerShown: true,
    ...
    >
      <Tabs.Screen name="shifts" options={{ title: "Os meus turnos" }} />
